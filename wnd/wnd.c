...
/*   Updated: 2020/02/13 21:03:58 by dbendu           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_wnd						wnd_create(void)
{
	...
	wnd.ant_img = img_create_from_xpm_src(wnd.mlxptr, "images/ant.xpm");
	wnd.start_circle_img = img_create_from_xpm_src(wnd.mlxptr,
													"images/start.xpm");
	wnd.end_circle_img = img_create_from_xpm_src(wnd.mlxptr, "images/end.xpm");
	wnd.pentagon_img =  img_create_from_xpm_src(wnd.mlxptr, "images/pentagon.xpm");
	return (wnd);
}
